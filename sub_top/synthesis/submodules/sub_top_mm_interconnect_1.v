...
module sub_top_mm_interconnect_1 (
	...
	wire   [4:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> audio_0_avalon_audio_slave_agent:cp_channel
	...
	wire  [13:0] video_dma_controller_0_avalon_dma_control_slave_agent_m0_address;                   // video_dma_controller_0_avalon_dma_control_slave_agent:m0_address -> video_dma_controller_0_avalon_dma_control_slave_translator:uav_address
	...
	wire  [90:0] video_dma_controller_0_avalon_dma_control_slave_agent_rf_source_data;               // video_dma_controller_0_avalon_dma_control_slave_agent:rf_source_data -> video_dma_controller_0_avalon_dma_control_slave_agent_rsp_fifo:in_data
	...
	wire  [90:0] video_dma_controller_0_avalon_dma_control_slave_agent_rsp_fifo_out_data;            // video_dma_controller_0_avalon_dma_control_slave_agent_rsp_fifo:out_data -> video_dma_controller_0_avalon_dma_control_slave_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> video_dma_controller_0_avalon_dma_control_slave_agent:cp_data
	...
	wire  [89:0] video_dma_controller_0_avalon_dma_control_slave_agent_rp_data;                      // video_dma_controller_0_avalon_dma_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [89:0] cmd_demux_src1_data;                                                                // cmd_demux:src1_data -> crosser:in_data
	...
	wire  [89:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_001:sink0_data
	...
	wire  [89:0] rsp_demux_001_src0_data;                                                            // rsp_demux_001:src0_data -> crosser_001:in_data
	...
	wire  [89:0] crosser_001_out_data;                                                               // crosser_001:out_data -> rsp_mux:sink1_data
	...
	sub_top_mm_interconnect_1_router_002 router_003 (
	...
	sub_top_mm_interconnect_1_router_002 router_004 (
	...
	sub_top_mm_interconnect_1_router_005 router_005 (
	...
	sub_top_mm_interconnect_1_router_005 router_006 (
	...
	sub_top_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (video_pll_0_vga_clk_clk),                                  //       clk.clk
		.reset               (video_dma_controller_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_1_cmd_mux_003 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_1_cmd_mux_003 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_1_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_1_cmd_demux_001 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
