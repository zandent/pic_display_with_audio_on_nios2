...
module sub_top_mm_interconnect_0 (
	...
	wire  [107:0] cmd_mux_004_src_data;                                                                        // cmd_mux_004:src_data -> nios2_qsys_0_debug_mem_slave_agent:cp_data
	...
	wire  [107:0] audio_0_avalon_audio_slave_agent_rp_data;                                                    // audio_0_avalon_audio_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [107:0] nios2_qsys_0_debug_mem_slave_agent_rp_data;                                                  // nios2_qsys_0_debug_mem_slave_agent:rp_data -> router_007:sink_data
	...
	wire    [5:0] cmd_demux_001_src2_channel;                                                                  // cmd_demux_001:src2_channel -> crosser_002:in_channel
	...
	wire    [5:0] crosser_002_out_channel;                                                                     // crosser_002:out_channel -> cmd_mux_002:sink0_channel
	...
	wire    [5:0] rsp_demux_002_src0_channel;                                                                  // rsp_demux_002:src0_channel -> crosser_005:in_channel
	...
	wire    [5:0] crosser_005_out_channel;                                                                     // crosser_005:out_channel -> rsp_mux_001:sink2_channel
	...
	sub_top_mm_interconnect_0_router_004 router_004 (
	...
	sub_top_mm_interconnect_0_router_004 router_005 (
	...
	sub_top_mm_interconnect_0_router_004 router_006 (
	...
	sub_top_mm_interconnect_0_router_007 router_007 (
	...
	sub_top_mm_interconnect_0_router_007 router_008 (
	...
	sub_top_mm_interconnect_0_cmd_demux_002 cmd_demux_002 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (video_pll_0_vga_clk_clk),                                  //       clk.clk
		.reset               (video_dma_controller_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_0_cmd_demux_002 rsp_demux (
		.clk                (sys_sdram_pll_0_sdram_clk_clk),                                 //       clk.clk
		.reset              (new_sdram_controller_0_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	sub_top_mm_interconnect_0_cmd_demux rsp_demux_002 (
		.clk                (video_pll_0_vga_clk_clk),                                  //       clk.clk
		.reset              (video_dma_controller_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_0_cmd_demux_002 rsp_demux_004 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_0_cmd_demux_002 rsp_demux_005 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_0_rsp_mux_002 rsp_mux_002 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
