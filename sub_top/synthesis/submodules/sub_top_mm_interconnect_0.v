...
module sub_top_mm_interconnect_0 (
	...
	wire  [88:0] audio_0_avalon_audio_slave_agent_rf_source_data;                                    // audio_0_avalon_audio_slave_agent:rf_source_data -> audio_0_avalon_audio_slave_agent_rsp_fifo:in_data
	...
	wire  [88:0] audio_0_avalon_audio_slave_agent_rsp_fifo_out_data;                                 // audio_0_avalon_audio_slave_agent_rsp_fifo:out_data -> audio_0_avalon_audio_slave_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> audio_0_avalon_audio_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                                  // audio_0_avalon_audio_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [3:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> audio_0_avalon_audio_slave_agent:cp_channel
	...
	wire  [87:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> jtag_uart_0_avalon_jtag_slave_agent:cp_data
	...
	wire  [87:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> nios2_qsys_0_jtag_debug_module_agent:cp_data
	...
	wire  [87:0] audio_0_avalon_audio_slave_agent_rp_data;                                           // audio_0_avalon_audio_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [87:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                                        // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [87:0] nios2_qsys_0_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_0_jtag_debug_module_agent:rp_data -> router_004:sink_data
	...
	sub_top_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sub_top_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
